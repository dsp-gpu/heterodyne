...
description: "C3 Component — key classes и интерфейсы репо heterodyne."
---

# C3 Component — `heterodyne`
...
### `test_heterodyne_rocm::HeterodyneCorrectBenchmarkROCm`

- **Namespace:** `test_heterodyne_rocm`
- **Методы:** 3, **test_params rows:** 0
- **Brief:** *(описание не задано)*

### `test_heterodyne_rocm::HeterodyneDechirpBenchmarkROCm`

- **Namespace:** `test_heterodyne_rocm`
- **Методы:** 3, **test_params rows:** 0
- **Brief:** *(описание не задано)*

### `drv_gpu_lib::IBackend`

- **Namespace:** `drv_gpu_lib`
- **Методы:** 1, **test_params rows:** 0
- **Brief:** *(описание не задано)*
